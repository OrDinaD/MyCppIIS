...
struct CallbackWrapper {
    HTTPClient::ResponseCallback userCallback;
    HTTPClient* client;
};
...
std::string HTTPClient::buildHeadersString(const std::map<std::string, std::string>& additionalHeaders) const {
...
std::string HTTPClient::buildFullUrl(const std::string& endpoint) const {
...
void HTTPClient::get(const std::string& endpoint, ResponseCallback callback) {
...
void HTTPClient::post(const std::string& endpoint, 
...
void HTTPClient::put(const std::string& endpoint,
                    const std::string& body,
                    ResponseCallback callback) {
    std::map<std::string, std::string> defaultContentType = {
        {"Content-Type", "application/json"}
...
void HTTPClient::del(const std::string& endpoint, ResponseCallback callback) {
    performRequest(HTTPMethodTypeDELETE, endpoint, "", {}, callback);
}

void HTTPClient::del(const std::string& endpoint,
                    const std::map<std::string, std::string>& headers,
                    ResponseCallback callback) {
    performRequest(HTTPMethodTypeDELETE, endpoint, "", headers, callback);
}

void HTTPClient::performRequest(HTTPMethodType method,
